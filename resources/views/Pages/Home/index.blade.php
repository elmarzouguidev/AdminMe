                                ...
                                <div class="card-body p-0">
                                    <div class="p-4">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mb-3">
                                                <span class="d-block fw-semibold fs-15">Water
                                                    Tracking</span>
                            ...
                            <div class="card custom-card overflow-hidden">
                                <div class="card-body p-0">
                                    <div class="p-4">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="mb-3">
                                                <span class="d-block fw-semibold fs-15">Sleep
                                                    Tracking</span>
                                    ...
                                    <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                        ...
                                        <div>
                                            <span class="avatar bg-light text-purple"><i
                                                    class="bi bi-twitter fs-16"></i></span>
                                        </div>
                                    </div>
                                    <p class="mb-2 fs-24 fw-semibold">2.1K</p>
                                    <div class="flex-between">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="input-group mt-3">
                                            ...
                                            <input type="text" value="2000" aria-label="First name"
                                                class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row gy-sm-0 gy-3">
                                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-2 col-4 text-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="d-block pt-2 text-muted fw-semibold">Bills</a>
                                        </div>
                                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-2 col-4 text-center">
                                            <a aria-label="anchor" href="javascript:void(0);"
                                        ...
                                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-2 col-4 text-center">
                                            ...
                                            <a href="javascript:void(0);"
                                                class="d-block pt-2 text-muted fw-semibold">Food</a>
                                        </div>
                                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-2 col-4 text-center">
                                            <a aria-label="anchor" href="javascript:void(0);"
                                        ...
                                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-2 col-4 text-center">
                                            <a aria-label="anchor" href="javascript:void(0);"
                                                class="btn btn-light border-0 px-4 py-3 lh-1 rounded">
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                <div class="card-header justify-content-between">
                                    ...
                                    <button type="button" class="btn btn-sm btn-light">View
                                        All</button>
                                </div>
                                <div class="card-body">
                                    <ul class="list-unstyled mb-0 personal-upcoming-events">
                                        <li>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-fill">
                                                    <span>Meeting with <span class="text-primary fw-semibold">Umar
                                                            Xai</span></span>
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-fill">
                                                    <span><span class="text-primary fw-semibold">Shin
                                                            Map</span> Birthday Party</span>
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-fill">
                                                    <span>Meeting with <span class="text-primary fw-semibold">Irav
                                                            Ert</span></span>
                                                    <span class="d-block text-muted fs-12">45
                                                        Minutes</span>
                                                </div>
                                                <div>
                        ...
                        <div class="col-xl-6">
                            <div class="card custom-card">
                                <div class="card-header justify-content-between">
                                    ...
                                    <button type="button" class="btn btn-light btn-sm btn-wave">View
                                        All</button>
                                </div>
                                <div class="card-body">
                                    <div class="avatar-list-stacked mb-4">
                                        ...
                                        <ul class="list-unstyled mb-0 personal-messages-list">
                                            <li>
                                                <div class="d-flex flex-wrap align-items-center">
                                                    ...
                                                    <div class="flex-fill">
                                                        ...
                                                        <span class="fs-12 text-muted d-block message">Hello
                                                            there! How are you doing? Call me when...</span>
                                                    </div>
                                                    <div class="text-end">
                                                        <span class="d-block text-muted fs-12">2
                                                            min</span>
                                            ...
                                            <li>
                                                <div class="d-flex flex-wrap align-items-center">
                                                    ...
                                                    <div class="flex-fill">
                                                        <span class="fw-semibold d-block">Shakira
                                                            Shen</span>
                                                        <span class="fs-12 text-muted d-block message">I
                                            ...
                                            <li>
                                                <div class="d-flex flex-wrap align-items-center">
                                                    ...
                                                    <div class="flex-fill">
                                                        ...
                                                        <span class="fs-12 text-muted d-block message">Shall
                            ...
                            <ul class="list-unstyled personal-favourite-contacts mb-0">
                                <li>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a aria-label="anchor" href="javascript:void(0);" class="text-danger me-2"><i
